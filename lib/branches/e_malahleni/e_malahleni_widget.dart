...
import 'e_malahleni_model.dart';
export 'e_malahleni_model.dart';

class EMalahleniWidget extends StatefulWidget {
  const EMalahleniWidget({super.key});

  static String routeName = 'EMalahleni';
  static String routePath = '/eMalahleni';

  @override
  State<EMalahleniWidget> createState() => _EMalahleniWidgetState();
}

class _EMalahleniWidgetState extends State<EMalahleniWidget>
    with TickerProviderStateMixin {
  late EMalahleniModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EMalahleniModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EMalahleni'});
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'E_MALAHLENI_PAGE_menu_ICN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            FFButtonWidget(
                                                                              onPressed: () async {
                                                                                ...
                                                                                FFAppState().contactBranch = 'EMalahleni';
                                                                                safeSetState(() {});
                                                                                logFirebaseEvent('Button_navigate_to');

                                                                                context.pushNamed(ContactUsWidget.routeName);
                                                                              },
                                                                              text: 'Contact EMalahleni',
                                                                  ...
                                                                  children: [
                                                                    FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'E_MALAHLENI_PAGE_youtube_ICN_ON_TAP');
                                                                        logFirebaseEvent(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'E_MALAHLENI_PAGE_spotify_ICN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'IconButton_launch_u_r_l');
                                                                          await launchURL(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'E_MALAHLENI_PAGE_apple_ICN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'IconButton_launch_u_r_l');
                                                                          await launchURL(
