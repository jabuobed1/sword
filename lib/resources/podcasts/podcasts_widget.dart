...
class PodcastsWidget extends StatefulWidget {
  ...
  static String routeName = 'Podcasts';
                                                      ...
                                                      children: [
                                                        if (responsiveVisibility(
                                                          ...
                                                          InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'PODCASTS_PAGE_Container_foopl1uy_ON_TAP');
                                                              logFirebaseEvent(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'PODCASTS_PAGE_LOCATIONS_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Button_navigate_to');
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'PODCASTS_PAGE_WATCH_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Button_navigate_to');
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'PODCASTS_PAGE_ABOUT_US_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Button_navigate_to');
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'PODCASTS_LISTEN_ON_SPOTIFY_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_launch_u_r_l');
                                                                    await launchURL(
                                                                        'https://open.spotify.com/show/6ipE1LNOSfxnwyrvPKIXmD?si=515d89e8c9014e15');
                                                                  },
                                                                  text:
                                                                      'Listen On Spotify',
                                                                  options:
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'PODCASTS_PAGE_Container_nqzhs78x_ON_TAP');
                                                                  logFirebaseEvent(
                                                                            ...
                                                                            children: [
                                                                              Expanded(
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Text(
                                                                                    columnPodcastRecord.description,
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                          fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                          color: FlutterFlowTheme.of(context).primaryText,
                                                                                          fontSize: 16.0,
                                                                            ...
                                                                            children: [
                                                                              Expanded(
                                                                                child: Padding(
                                                                                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 5.0, 5.0),
                                                                                  child: Text(
                                                                                    dateTimeFormat("yMMMd", columnPodcastRecord.date!),
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                          fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                          color: FlutterFlowTheme.of(context).primaryText,
                                                                                          fontSize: 16.0,
                                                                              ...
                                                                              Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  dateTimeFormat("Hm", columnPodcastRecord.date!),
