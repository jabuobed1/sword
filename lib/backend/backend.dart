...
/// Functions to query SermonsRecords (as a Stream and as a Future).
Future<int> querySermonsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SermonsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SermonsRecord>> querySermonsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      SermonsRecord.collection,
      SermonsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SermonsRecord>> querySermonsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query SignUpsRecords (as a Stream and as a Future).
Future<int> querySignUpsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SignUpsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SignUpsRecord>> querySignUpsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SignUpsRecord.collection,
      SignUpsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SignUpsRecord>> querySignUpsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
