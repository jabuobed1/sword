...
class SignUpModel extends FlutterFlowModel<SignUpWidget> {
  ...
  // State field(s) for signUpType widget.
  String? signUpTypeValue;
  FormFieldController<String>? signUpTypeValueController;
  ...
  // State field(s) for signUpTypeM widget.
  String? signUpTypeMValue;
  FormFieldController<String>? signUpTypeMValueController;
