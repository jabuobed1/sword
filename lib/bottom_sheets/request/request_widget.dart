...
class _RequestWidgetState extends State<RequestWidget> {
  ...
  void initState() {
    ...
    _model.messageTextController ??= TextEditingController(
        text:
            'Hi SSMI, I would like to request for ${FFAppState().requestType}, please feel free to reach me on the number provided above.');
    _model.messageFocusNode ??= FocusNode();

    _model.nameMTextController ??= TextEditingController();
    _model.nameMFocusNode ??= FocusNode();

    _model.surnameMTextController ??= TextEditingController();
    _model.surnameMFocusNode ??= FocusNode();
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('REQUEST_COMP_Icon_mkwcmt5u_ON_TAP');
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 10.0, 20.0, 0.0),
                              child: Text(
                                'Please provide the details for the ${FFAppState().requestType} Request',
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: FlutterFlowDropDown<
                                                      String>(
                                                    controller: _model
                                                            .requestTypeValueController1 ??=
                                                        FormFieldController<
                                                            String>(
                                                      _model.requestTypeValue1 ??=
                                                          FFAppState()
                                                              .requestType,
                                                    ),
                                                    options: [
                                      ...
                                      child: FFButtonWidget(
                                        onPressed:
                                            ((_model.nameTextController.text ==
                                                ...
                                                : () async {
                                                    logFirebaseEvent(
                                                        'REQUEST_COMP_SUBMIT_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_backend_call');
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .surnameMTextController,
                                                      focusNode: _model
                                                          .surnameMFocusNode,
                                                      onChanged: (_) =>
                                                          EasyDebounce.debounce(
                                                        '_model.surnameMTextController',
                                                        Duration(
                                                            milliseconds: 100),
                                                        () =>
                                                            safeSetState(() {}),
                                                      ...
                                                      cursorColor:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .primaryText,
                                                      validator: _model
                                                          .surnameMTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: FlutterFlowDropDown<
                                                      String>(
                                                    controller: _model
                                                            .requestTypeValueController2 ??=
                                                        FormFieldController<
                                                            String>(
                                                      _model.requestTypeValue2 ??=
                                                          valueOrDefault<
                                                              String>(
                                                        FFAppState()
                                                            .requestType,
