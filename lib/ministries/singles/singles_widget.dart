...
import 'singles_model.dart';
export 'singles_model.dart';

class SinglesWidget extends StatefulWidget {
  const SinglesWidget({super.key});

  static String routeName = 'Singles';
  static String routePath = '/singles';

  @override
  State<SinglesWidget> createState() => _SinglesWidgetState();
}

class _SinglesWidgetState extends State<SinglesWidget> {
  late SinglesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SinglesModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Singles'});
                                                        ...
                                                        children: [
                                                          if (responsiveVisibility(
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SINGLES_PAGE_Container_grngofyr_ON_TAP');
                                                                logFirebaseEvent(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'SINGLES_PAGE_LOCATIONS_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'SINGLES_PAGE_ABOUT_US_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'SINGLES_PAGE_CircleImage_n0smfzvo_ON_TAP');
                                                          logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('SINGLES_PAGE_LEARN_MORE_BTN_ON_TAP');
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'SINGLES_PAGE_VOLUNTEER_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                            ...
                                                                            children: [
                                                                              FFButtonWidget(
                                                                                onPressed: !wrapEventsRecord.booking
                                                                                    ? null
                                                                                    : () async {
                                                                                        logFirebaseEvent('SINGLES_PAGE_REGISTER_BTN_ON_TAP');
                                                                                        logFirebaseEvent('Button_navigate_to');
