...
import 'youth_model.dart';
export 'youth_model.dart';

class YouthWidget extends StatefulWidget {
  const YouthWidget({super.key});

  static String routeName = 'Youth';
  static String routePath = '/youth';

  @override
  State<YouthWidget> createState() => _YouthWidgetState();
}

class _YouthWidgetState extends State<YouthWidget> {
  late YouthModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YouthModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Youth'});
                                                        ...
                                                        children: [
                                                          if (responsiveVisibility(
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'YOUTH_PAGE_Container_v83nrik8_ON_TAP');
                                                                logFirebaseEvent(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUTH_PAGE_LOCATIONS_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUTH_PAGE_ABOUT_US_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'YOUTH_PAGE_CircleImage_z14cxx9q_ON_TAP');
                                                          logFirebaseEvent(
                                                        ...
                                                        Container(
                                                          ...
                                                          decoration:
                                                            ...
                                                            image:
                                                              ...
                                                              image:
                                                                  Image.asset(
                                                                'assets/images/IMG-20250919-WA0008.jpg',
                                                              ).image,
                                                            ),
                                                            boxShadow: [
                                                              BoxShadow(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('YOUTH_PAGE_LEARN_MORE_BTN_ON_TAP');
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'YOUTH_PAGE_VOLUNTEER_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                            ...
                                                                            children: [
                                                                              FFButtonWidget(
                                                                                onPressed: !wrapEventsRecord.booking
                                                                                    ? null
                                                                                    : () async {
                                                                                        logFirebaseEvent('YOUTH_PAGE_REGISTER_BTN_ON_TAP');
                                                                                        logFirebaseEvent('Button_navigate_to');
