...
import 'counseling_model.dart';
export 'counseling_model.dart';

class CounselingWidget extends StatefulWidget {
  const CounselingWidget({super.key});

  static String routeName = 'Counseling';
  static String routePath = '/counseling';

  @override
  State<CounselingWidget> createState() => _CounselingWidgetState();
}

class _CounselingWidgetState extends State<CounselingWidget> {
  late CounselingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CounselingModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Counseling'});
                              ...
                              ClipRRect(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(30.0),
                                    child: Image.asset(
                                      'assets/images/Counselling_(2).png',
                                      width: 200.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                                                        ...
                                                        children: [
                                                          if (responsiveVisibility(
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'COUNSELING_Container_1t67ewod_ON_TAP');
                                                                logFirebaseEvent(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'COUNSELING_PAGE_LOCATIONS_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'COUNSELING_PAGE_WATCH_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'COUNSELING_PAGE_ABOUT_US_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'COUNSELING_PAGE_GIVE_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'COUNSELING_PAGE_menu_ICN_ON_TAP');
                                                              logFirebaseEvent(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'COUNSELING_CircleImage_74kqlth7_ON_TAP');
                                                            logFirebaseEvent(
                                                                  ...
                                                                  children: [
                                                                    FFButtonWidget(
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'COUNSELING_PAGE_BOOK_BTN_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Button_update_app_state');
                                                                        FFAppState().requestType =
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      image: DecorationImage(
                                                        fit: BoxFit.cover,
                                                        image: Image.asset(
                                                          'assets/images/Marriage_Counselling.png',
                                                        ).image,
                                                      ),
                                                      boxShadow: [
                                                        BoxShadow(
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                      ...
                                                      image: DecorationImage(
                                                        fit: BoxFit.cover,
                                                        image: Image.asset(
                                                          'assets/images/Counselling_Individual.png',
                                                        ).image,
                                                      ),
                                                      boxShadow: [
                                                        BoxShadow(
