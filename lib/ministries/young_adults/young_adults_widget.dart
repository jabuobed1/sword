...
import 'young_adults_model.dart';
export 'young_adults_model.dart';

class YoungAdultsWidget extends StatefulWidget {
  const YoungAdultsWidget({super.key});

  static String routeName = 'YoungAdults';
  static String routePath = '/youngAdults';

  @override
  State<YoungAdultsWidget> createState() => _YoungAdultsWidgetState();
}

class _YoungAdultsWidgetState extends State<YoungAdultsWidget> {
  late YoungAdultsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YoungAdultsModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'YoungAdults'});
                                                        ...
                                                        children: [
                                                          if (responsiveVisibility(
                                                            ...
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'YOUNG_ADULTS_Container_hkw9b7bt_ON_TAP');
                                                                logFirebaseEvent(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUNG_ADULTS_PAGE_LOCATIONS_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUNG_ADULTS_PAGE_WATCH_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUNG_ADULTS_PAGE_ABOUT_US_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUNG_ADULTS_PAGE_CARE_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'YOUNG_ADULTS_PAGE_GIVE_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_navigate_to');
                                                        ...
                                                        Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'YOUNG_ADULTS_PAGE_menu_ICN_ON_TAP');
                                                              logFirebaseEvent(
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'YOUNG_ADULTS_CircleImage_5i3ph0lx_ON_TAP');
                                                          logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('YOUNG_ADULTS_PAGE_LEARN_MORE_BTN_ON_TAP');
                                                                              logFirebaseEvent('Button_navigate_to');

                                                                              context.pushNamed(BaptismWidget.routeName);
                                                                            },
                                                                            text:
                                                                                'Learn More',
                                                                            options:
                                                          ...
                                                          Padding(
                                                            ...
                                                            child:
                                                              ...
                                                              onPressed:
                                                                  () async {
                                                                logFirebaseEvent(
                                                                    'YOUNG_ADULTS_PAGE_VOLUNTEER_BTN_ON_TAP');
                                                                logFirebaseEvent(
                                                                            ...
                                                                            children: [
                                                                              FFButtonWidget(
                                                                                onPressed: !wrapEventsRecord.booking
                                                                                    ? null
                                                                                    : () async {
                                                                                        logFirebaseEvent('YOUNG_ADULTS_PAGE_REGISTER_BTN_ON_TAP');
                                                                                        logFirebaseEvent('Button_navigate_to');
